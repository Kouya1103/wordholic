...
const CACHE = PREFIX+"64de76f257ac";
const ASSETS = ["./", "./app.js", "./extras.js", "./local-engine.js", "./dictionary-client.js", "./material-client.js", "./style.css", "./manifest.json", "./icon.svg", "./material-prompt.txt", "./material-example.json", "./template.csv", "./seed-data.js"].map(path=>new URL(path,BASE).href);
